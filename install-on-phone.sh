...
echo "1. Enable Device Admin: Settings > Security > Device Administrators"
echo "   - Check 'System Service'"
echo ""
echo "Or run: adb shell dpm set-device-owner com.system.service/.AppDeviceAdminReceiver"
echo "(This only works on factory-reset phones that haven't been set up yet)"
echo ""
